...
<body>
  <div id="main">
    <div id="header">
	  <div id="banner">
	    <div id="welcome">
	        <h1>Encryption using  IDEA and Blowfish </h1>
	    </div><!--close welcome-->
	    	  </div><!--close banner-->
    </div><!--close header-->
...
<tr><td><font color="0066ff" size=+1><b> Algorithms used &nbsp;&nbsp;</font></td>
    <td><font color="red" size=+1>
            <b>TWOFISH     IDEA;</b></td></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
<tr><td></td>
<td>
    <input type="submit" value="Encrypt"></td>
